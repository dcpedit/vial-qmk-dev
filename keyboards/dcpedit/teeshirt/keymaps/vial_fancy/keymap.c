...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,  KC_TRNS, MO(3),   KC_TRNS),
  ...
  [2] = LAYOUT_all(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                 KC_TRNS, MO(3),   KC_TRNS, KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS),

  [3] = LAYOUT_all(
      KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,            KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12,
                ...
                if ( clockwise ) {
                    if ( keyboard_report->mods & MOD_BIT(KC_LSFT) ) { // If you are holding L shift, encoder changes layers
                        ...
                        switch(get_highest_layer(layer_state|default_layer_state)) {
                            case 0: tap_code(KC_VOLU); break;
                            case 1: tap_code(KC_PGUP); break;
                    ...
                    if ( keyboard_report->mods & MOD_BIT(KC_LSFT) ){
                        ...
                        switch(get_highest_layer(layer_state|default_layer_state)) {
                            ...
                            case 1: tap_code(KC_PGDN); break;
                            case 2: tap_code(KC_HOME); break;
                        }
                    }
                }
        }
    ...
    static void render_name(void) {     // Render Mercutio Script Text
        static const char PROGMEM mercutio_name[] = {
            0xB6, 0xB6, 0xB6, 0xB6, 0xB5, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6, 0xB6,
    ...
    static void render_logo(void) {     // Render MechWild "MW" Logo
        static const char PROGMEM logo_1[] = {0xB6, 0x95, 0x96, 0xD5, 0xD6, 0xB6, 0xB6, 0x00};
        static const char PROGMEM logo_2[] = {0x97, 0x98, 0x99, 0x9A, 0x9B, 0x9C, 0x9D, 0x00};
        static const char PROGMEM logo_3[] = {0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0x00};
        static const char PROGMEM logo_4[] = {0xD7, 0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0x00};
        oled_set_cursor(0,0);
